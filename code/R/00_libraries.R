...
# MuMIn: Multi-Model Inference - called via MuMIn::r.squaredGLMM() in 10_temporal_analysis.R
# mgcv: Generalized Additive Models (GAMs) for temporal recovery curves
...
library(lmerTest)
library(car)
# library(MuMIn)     # Called via :: operator in 10_temporal_analysis.R (no library() needed)
...
# (sf already loaded above in Mapping and Spatial section)
