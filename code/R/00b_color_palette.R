...
#'   4. Consistent with existing Fig 2 convention (green = density, orange = biomass).
...
# =============================================================================
# Maintains the existing Fig 2 convention: green family for density,
...
# =============================================================================
# 6b. MODEL SELECTION COLORS (originally Fig S7, now dropped from SI)
# =============================================================================
...
"Linear"     = "#4A6670",   # Dark slate
  "Asymptotic" = "#A8BFC9",   # Pale blue-grey
  "Sigmoid"    = "#3D5A80",   # Navy blue
  "Mean"       = "#98A4AE"    # Neutral grey
)
...
col_variance <- c(
  ...
  "Source" = "#8B7355"    # Warm brown (data/institutional concept)
)


# =============================================================================
# 6d. EFFECT SIGN / DIRECTION COLORS
# =============================================================================
# Used in conceptual diagrams (Fig S1) and any annotations showing positive vs
# negative MPA effects. From the Okabe-Ito palette for maximum accessibility.

col_effect <- c(
  "positive" = "#009E73",   # Bluish green (Okabe-Ito)
  "negative" = "#D55E00"    # Vermilion (Okabe-Ito)
)


# =============================================================================
# 6e. CASCADE CONSISTENCY COLORS (SI Fig S5, disk: fig_s06, panel b)
# =============================================================================
...
# =============================================================================
# 6f. DIVERGING PALETTE (used for temporal gradient in SI Fig S4 / fig_s05_cascade_phase)
# =============================================================================
# Blue-white-red diverging scheme for lnRR or RR heatmaps.
# Symmetric perceptually around white midpoint.

col_heatmap <- c(
  "low"  = "#B2182B",   # Brick red (negative lnRR = decline inside MPA)
  "mid"  = "white",
  "high" = "#2166AC"    # Steel blue (positive lnRR = increase inside MPA)
)
