# Literature Source Copies

This public analysis repo does not track publisher PDF or saved-webpage source
...
manifest for citation audits, Zotero/NotebookLM sync, and manuscript review.

The analysis repo retains only this pointer so code reviewers understand why
`literature/pdfs/` is intentionally absent.
